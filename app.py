...
def get_distribution():
    ...
    try:
        ...
        table = prettytable.PrettyTable(['a', 'b', 'c', 'd'])
        table.align = 'l'
        table.add_row([a_global, b_global, c_global, d_global])

        table2 = prettytable.PrettyTable(['a', 'b', 'c', 'd'])
        table2.align = 'l'
        ...
        table2.add_row([a_per, b_per, c_per, d_per])

        response_str += f'Overall : \nNumber Of Questions :{questions_number_global}\n'
        response_str += f'{table.get_string()}\n'
        response_str += f'{table2.get_string()}\n\n\n'
